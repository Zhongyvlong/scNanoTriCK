...
# annotation_results <-
# 	read.table("Ex4d_NGS_K562_H3K9me3_peak_annotation_for_repetitive_elements.txt",
# 		header = T)
# annotation_results <-
# 	read.table("Ex4d_scNanoTriCK_K562_H3K9me3_peak_annotation_for_repetitive_elements.txt",
# 		header = T)
