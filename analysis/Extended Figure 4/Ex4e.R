...
# annotation_results <-
# 	read.table("Ex4e_NGS_GM12878_LaminB1_peak_annotation_for_repetitive_elements.txt",
# 		header = T)
# annotation_results <-
# 	read.table("Ex4e_scNanoTriCK_GM12878_LaminB1_peak_annotation_for_repetitive_elements.txt",
# 		header = T)
